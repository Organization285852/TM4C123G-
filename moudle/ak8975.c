...
{
	u8 b=0x01;
	return I2CWriteToReg(AK8975_ADDRESS,AK8975_CNTL,&b,1);	
}
...
//	IIC_Read_1Byte(AK8975_ADDRESS,AK8975_HXH,&ak8975_buffer[1]);
	I2CReadToBuf(AK8975_ADDRESS,AK8975_HXL,&ak8975_buffer[0],1);
	I2CReadToBuf(AK8975_ADDRESS,AK8975_HXH,&ak8975_buffer[1],1);
...
//	IIC_Read_1Byte(AK8975_ADDRESS,AK8975_HYH,&ak8975_buffer[3]);
	...
	I2CReadToBuf(AK8975_ADDRESS,AK8975_HYL,&ak8975_buffer[2],1);
	I2CReadToBuf(AK8975_ADDRESS,AK8975_HYH,&ak8975_buffer[3],1);
...
//	IIC_Read_1Byte(AK8975_ADDRESS,AK8975_HZH,&ak8975_buffer[5]);
	I2CReadToBuf(AK8975_ADDRESS,AK8975_HZL,&ak8975_buffer[4],1);
	I2CReadToBuf(AK8975_ADDRESS,AK8975_HZH,&ak8975_buffer[5],1);
